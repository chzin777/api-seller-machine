...
const createCliente = async (req, res) => {
    try {
        ...
        const newCliente = await index_1.prisma.cliente.create({
            data: {
                nome,
                cpfCnpj,
                cidade,
...
const updateCliente = async (req, res) => {
    try {
        ...
        const updatedCliente = await index_1.prisma.cliente.update({
            where: { id: clienteId },
            data: {
                ...(nome && { nome }),
                ...(cpfCnpj && { cpfCnpj }),
...
const getClienteByDocumento = async (req, res) => {
    try {
        ...
        const cliente = await index_1.prisma.cliente.findFirst({
 ...
 */
const getClientesByCidade = async (req, res) => {
    try {
 ...
 */
const getClientesByEstado = async (req, res) => {
    try {
