...
exports.MixPortfolioResolver = void 0;
const type_graphql_1 = require("type-graphql");
const MixPortfolioTypes_1 = require("../types/MixPortfolioTypes");
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
let MixPortfolioResolver = class MixPortfolioResolver {
    async mixPorTipo(periodo, filialId) {
        try {
            const whereClause = {};
            if (filialId) {
            ...
            const totaisGerais = Object.values(totaisPorTipo).reduce((acc, tipo) => ({
    ...
    async precoRealizadoVsReferencia(input) {
        try {
            const whereClause = {};
            if (input.filialId) {
    ...
    async produtosSemGiro(input) {
        ...
        try {
            ...
            return {
                periodo: `${input.dataInicio} - ${input.dataFim}`,
                filialId: input.filialId || 0,
                tipoFiltro: (_a = input.tipos) === null || _a === void 0 ? void 0 : _a.join(','),
                resumoPorTipo,
...
exports.MixPortfolioResolver = MixPortfolioResolver;
__decorate([
    (0, type_graphql_1.Query)(() => MixPortfolioTypes_1.MixTipoAnalise),
    __param(0, (0, type_graphql_1.Arg)('periodo')),
    __param(1, (0, type_graphql_1.Arg)('filialId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], MixPortfolioResolver.prototype, "mixPorTipo", null);
__decorate([
    (0, type_graphql_1.Query)(() => MixPortfolioTypes_1.PrecoRealizadoAnalise),
    __param(0, (0, type_graphql_1.Arg)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MixPortfolioTypes_1.PrecoRealizadoInput]),
    __metadata("design:returntype", Promise)
], MixPortfolioResolver.prototype, "precoRealizadoVsReferencia", null);
__decorate([
    (0, type_graphql_1.Query)(() => MixPortfolioTypes_1.BundleRateAnalise),
    __param(0, (0, type_graphql_1.Arg)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MixPortfolioTypes_1.MixPortfolioInput]),
    __metadata("design:returntype", Promise)
], MixPortfolioResolver.prototype, "bundleRate", null);
__decorate([
    (0, type_graphql_1.Query)(() => MixPortfolioTypes_1.CrossSellAnalise),
    __param(0, (0, type_graphql_1.Arg)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MixPortfolioTypes_1.MixPortfolioInput]),
    __metadata("design:returntype", Promise)
], MixPortfolioResolver.prototype, "crossSell", null);
__decorate([
    (0, type_graphql_1.Query)(() => MixPortfolioTypes_1.ProdutosSemGiroAnalise),
    __param(0, (0, type_graphql_1.Arg)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MixPortfolioTypes_1.ProdutosSemGiroInput]),
    __metadata("design:returntype", Promise)
], MixPortfolioResolver.prototype, "produtosSemGiro", null);
exports.MixPortfolioResolver = MixPortfolioResolver = __decorate([
    (0, type_graphql_1.Resolver)()
], MixPortfolioResolver);
